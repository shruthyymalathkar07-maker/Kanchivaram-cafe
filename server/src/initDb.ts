...
const DDL_STATEMENTS: string[] = [
  ...
  "DO $$ BEGIN ALTER TABLE \"public\".\"Purchase\" ALTER COLUMN \"poNumber\" DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;",
  "DO $$ BEGIN ALTER TABLE \"public\".\"Purchase\" ALTER COLUMN \"totalCost\" DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;",
  "DO $$ BEGIN ALTER TABLE \"public\".\"PurchaseItem\" ALTER COLUMN \"totalCost\" DROP NOT NULL; EXCEPTION WHEN OTHERS THEN NULL; END $$;",
