  ...
  const cards = [
    {
      id: 'total-sales',
      title: 'TOTAL SALES',
      value: `₹${(stats?.kpis?.totalSales?.amount || 18450).toLocaleString('en-IN')}`,
      subtext: `${stats?.kpis?.totalSales?.orderCount || 186} Orders • +${stats?.kpis?.totalSales?.growth || 14.2}%`,
      icon: TrendingUp,
    ...
    },
    {
      id: 'net-sales',
      title: 'NET SALES',
      value: `₹${(stats?.kpis?.netSales?.amount || 16208).toLocaleString('en-IN')}`,
      subtext: `In-Store: ₹${(stats?.kpis?.netSales?.inStoreNet || 10800).toLocaleString('en-IN')}`,
      icon: DollarSign,
    ...
    },
    {
      id: 'discounts',
      title: 'DISCOUNTS',
      value: `₹${(stats?.kpis?.discounts?.amount || 1320).toLocaleString('en-IN')}`,
      subtext: `${stats?.kpis?.discounts?.transactionCount || 52} Discounted Bills`,
      icon: Tag,
    ...
    },
    {
      ...
      value: `₹${(stats?.kpis?.cashCollection?.amount || 9800).toLocaleString('en-IN')}`,
      subtext: `UPI: ₹${(stats?.kpis?.cashCollection?.upiAmount || 6450).toLocaleString('en-IN')}`,
      icon: Wallet,
    ...
    },
    {
      id: 'online-sales',
      title: 'ONLINE SALES',
      value: `₹${(stats?.kpis?.onlineSales?.amount || 6450).toLocaleString('en-IN')}`,
      subtext: `Swiggy: ₹${(stats?.kpis?.onlineSales?.swiggy || 4500).toLocaleString('en-IN')}`,
      icon: ShoppingBag,
